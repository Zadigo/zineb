...
if __name__ == '__main__':
    # runner = unittest.TextTestRunner()
    suite = unittest.TestSuite()
    tests = unittest.defaultTestLoader.loadTestsFromModule('zineb.tests', 'test_*.py')
    unittest.load_tests(unittest.defaultTestLoader, suite, pattern='test_*.py')
    unittest.main()
    # tests = unittest.load_tests(unittest.defaultTestLoader, suite, pattern='test_*.py')
    # print(tests)
