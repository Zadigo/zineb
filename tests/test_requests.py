...
from zineb.tests import create_test_json_request, create_test_request
...
class TestBaseRequest(unittest.TestCase):
    ...
    def test_link_following(self):
        ...
        self.assertEqual(response.cached_response.url, 'https://www.iana.org/domains/reserved')
...
_json_request = create_test_json_request()

class TestJsonRequest(unittest.TestCase):
    def test_response(self):
        self.assertIsInstance(_json_request.json_response, JsonResponse)
