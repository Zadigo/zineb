...
from typing import Any, Type, Dict, List, Literal, Optional, Generator, Union, Self

from zineb.utils.containers import Row
# from zineb.utils.containers import SmartDict
from zineb.models.datastructure import Model
from zineb.utils.containers import Synchronizer
...
class Column:
    ...
    column_rows: list = ...
    colum_values: list = ...
    def __init__(self, columns_instance: Columns,
                 index: int, field_name: str) -> None: ...
    ...
    def add_new_row(
        self, name: str, value: Union[int, str, float, list, dict, None], id_value: int = ...) -> None: ...
...
class Row:
    ...
    def __init__(self, field_id: int, field_name: str,
                 field_value: list[Any], fields: list[str]) -> None: ...
...
class SmartDict:
    ...
    def __init__(self, *fields: str,
                 order_by: Optional[List[List[str, bool]]]) -> None: ...
    ...
    def update(self, name: str,
               value: Union[str, int, float, list, dict]) -> None: ...
