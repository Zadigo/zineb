...
from zineb.models.fields import Field, AutoField
...
class Base(type):
    def __new__(cls: Type, name: str, bases: tuple,
                attrs: dict) -> Type[Model]: ...
...
class Model(metaclass=Base):
    ...
    def check_special_function(
        value: Union[str, int, float, Value]) -> None: ...

    @lru_cache(maxsize=10)
    def resolve_all_related_fields(seelf) -> list: ...
    def _bind_to_value_field(self, field_name: str,
                             data: Union[str, int, float]) -> None: ...

    def _get_field_by_name(self, field_name: str) -> Field: ...
    def update_id_field(self) -> AutoField: ...
    def add_calculated_value(self, name: str, value: Any, *
                             funcs: Optional[Union[Add, Divide, Substract, Multiply]]) -> None: ...

    def add_case(self, value: Any, case: When) -> None: ...
    def add_using_expression(self, name: str, tag: str,
                             attrs: Optional[dict] = ...) -> None: ...

    def add_values(self, **attrs) -> None: ...
    def add_value(self, name: str, value: Any) -> None: ...
    def check_constraints(
        self, clean_value: Union[str, int, float]) -> None: ...

    def full_clean(self, **kwargs) -> None: ...
    def clean(self, data: List, **kwargs) -> None: ...

    def save(self, commit: Optional[bool] = ..., filename: Optional[str] = ...,
             extension: Optional[Literal['json']] = ..., **kwargs) -> Union[None, Union[list, dict]]: ...
