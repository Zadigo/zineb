...
from typing import Callable, Iterable, Optional, OrderedDict, Self, Union
...
@lru_cache(maxsize=0)
def collect_files(dir_name: str, filter_func: Callable = ...) -> Union[filter, list[str], map]: ...
...
class RequestQueue:
    ...
    def __enter__(self, *args, **kwargs) -> OrderedDict: ...
